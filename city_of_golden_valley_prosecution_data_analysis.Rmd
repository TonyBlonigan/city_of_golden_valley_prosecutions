...
To compare the racial/ethnic makeup of the city to the racial/ethnic makeup of the population being prosecuted by CC, we must map the ACS races to the CC races. Imprecision in language used to describe races and ethnicity makes this is an imperfect process, but here is the mapping I used:
